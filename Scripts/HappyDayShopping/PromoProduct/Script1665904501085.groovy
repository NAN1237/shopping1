...
Mobile.tap(findTestObject('HappyDayShopping/PromoButton/BtnPromo'), 0)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('HappyDayShopping/PromoButton/PromoProduct'), 0)

Mobile.checkElement(findTestObject('HappyDayShopping/PromoButton/tittle_product_promo'), 0)
...
Mobile.tap(findTestObject('HappyDayShopping/PromoButton/FlashSaleProduct'), 0)
